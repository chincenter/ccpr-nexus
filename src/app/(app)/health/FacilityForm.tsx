...
const TYPES = ["clinic", "hospital", "mobile_clinic", "health_post", "other"];
...
export function FacilityForm({
  ...
  return (
    ...
    >
      <input name="name" placeholder="Facility name" required className="rounded-md border border-slate-300 px-2 py-1.5 text-sm lg:col-span-2" />
      <select name="facility_type" defaultValue="clinic" className="rounded-md border border-slate-300 px-2 py-1.5 text-sm">
        {TYPES.map((t) => (
      ...
      <input name="contact_person" placeholder="Contact person" className="rounded-md border border-slate-300 px-2 py-1.5 text-sm" />
      <input name="contact_phone" placeholder="Contact phone" className="rounded-md border border-slate-300 px-2 py-1.5 text-sm" />
